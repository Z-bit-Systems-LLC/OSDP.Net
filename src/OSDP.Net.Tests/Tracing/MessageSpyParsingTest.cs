...
[TestFixture]
[Category("Unit")]
public class MessageSpyParsingTest
{
    [Test]
    public void ParsePacket_Command()
    {
        // Arrange
    ...
    [Test]
    public void ParsePacket_Spaces()
    {
        // Arrange
        var testData = BinaryUtils.HexToBytes("53 00 0D 00 06 6A 00 02 02 02 01 59 92").ToArray();
        var messageSpy = new MessageSpy();
    ...
    [Test]
    public void ParseCaptureFile_Command()
    {
        var testEntry =
        ...
        var actual = messageSpy.ParseCaptureFile(testEntry).ToArray();
    ...
    [Test]
    public void ParseCaptureFile_Reply()
    {
        var testEntry =
    ...
    [Test]
    public void TryParsePacket_ValidCommand_ReturnsTrue()
    {
        // Arrange
        var testData = BinaryUtils.HexToBytes("53-00-0D-00-06-6A-00-02-02-02-01-59-92").ToArray();
        var messageSpy = new MessageSpy();
        ...
        // Act
        var result = messageSpy.TryParsePacket(testData, out var packet);
    ...
    [Test]
    public void TryParsePacket_ValidReply_ReturnsTrue()
    {
        // Arrange
        var testData = BinaryUtils.HexToBytes("53-80-14-00-06-45-00-0E-E3-10-10-00-00-74-97-23-06-06-1B-88").ToArray();
        var messageSpy = new MessageSpy();
    ...
    [Test]
    public void TryParsePacket_TruncatedData_ReturnsFalse()
    {
